...
| Explicitly requested durable HTML report, architecture explainer, showcase, or slide deck | `create-html-artifact` (manual invocation only; diagrams are normally frozen into the file) |
